...
import { aiTerminalPaneId, bracketedPaste, truncateText } from '@navide/plugin-shell'
...
import { initKeybindingsPort, useKeybindings, registerCommand, setContext, executeCommand } from '@navide/shared'
import { useTheme, BUILTIN_THEMES } from '@navide/ui-foundation'
import { initSettingsBackend, settingsGet, settingsSet, onSettingsChanged } from '@navide/shared'
