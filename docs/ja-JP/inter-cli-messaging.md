...
Navide に伝える Enter が続きません。したがって Pane が `awaiting` や `question`
から抜けたことをもって回答が受理されたとみなし、未送信の行はいずれにせよ最後の
...
| `mid-turn` | 対象 Agent が作業中 |
| `settling` | 対象が静かになったばかりで、落ち着くのを待っている |
